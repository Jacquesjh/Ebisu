...
SECTORS_AVAILABLE     = ["Servicos Comerciais", "Comunicacoes", "Consumiveis Duraveis", "Consumiveis nao Duraveis",
...
RULES_AVAILABLE       = ["include_tickers", "include_sectors", "exclude_tickers", "exclude_sectors"]
CONSTRAINTS_AVAILABLE = ["invest_sections", "invest_tickers"]
FILTERS_AVAILABLE     = ["Volume", "Momentum", "Random", "Min_Price", "Max_Price", "RoMad", "Volatility", "Sharpe", "Sortino"]
...
OPTIMIZERS_SECUNDARY_OPTIONS = {
    "HRP": {
        "covariance_function": ["sample_cov", "semicovariance", "exp_cov", "ledoit_wolf", "ledoit_wolf_constant_variance",
